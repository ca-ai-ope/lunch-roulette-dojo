...
このリポジトリには、研修の各Phaseに対応する3つのディレクトリがあります。
**Phase が切り替わるたびに、対応するディレクトリに移動してください。**
...
Phase 2 で壊れたコードや Phase 3 で実装した投票機能は、次のディレクトリには引き継ぎません。
